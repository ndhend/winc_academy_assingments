...
print(discounted_sum_total) # rounded to the nearest cent???

#Fortunately for us, there's a discount of 30%.
# Store this in a variable discount_percentage (hint: note the variable name already says 'percent'???)
